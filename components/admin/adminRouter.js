...
//           if (err) res.send(err);
//           logins.findOne({ memberId: uResult._id }, function (err, lResult) {
//             if (err) res.send(err);
//             if (lResult) {
//               bcrypt.genSalt(10, function (err, salt) {
...
//     if (err) {
//       return res.json({ message: "Error while feching the user by email", err });
//     }
...
// router.post("/getPayments", AdminController.getPayments);
